...
const Sponsor = () => {
  return (
    <div className="container mx-auto my-10 px-4 flex flex-col items-center text-center bg-gradient-to-r from-blue-100 to-blue-200 rounded-lg shadow-lg p-6">
      ...
      <button className="py-3 px-8 bg-blue-500 text-white text-lg font-semibold rounded-full shadow hover:bg-blue-600 transition-all transform hover:scale-105">
        Buy Us a Bone 🦴
      </button>
    </div>
  );
