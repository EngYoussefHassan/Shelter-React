...
const About = () => {
    return (
        <div className="container py-5">
            ...
            <h3>Our Story</h3>
            <p>Founded in 20XX, FurEver Home was established to provide a safe haven for abandoned and neglected animals. Over the years, we have rescued thousands of animals and helped them find loving homes.</p>
            <h3>Meet Our Team</h3>
            ...
            <h3>Our Partners</h3>
            <p>We are grateful for the support of our partners and sponsors who help us achieve our mission.</p>
            <h3>Contact Us</h3>
            <p><strong>Location:</strong> 123 Paws Street, Barktown, Cuddle County, 56789, USA<br />
                <strong>Phone:</strong> +1 (555) 123-4567<br />
                <strong>Email:</strong> contact@fureverhome.org
            </p>
            <h3>Get Involved</h3>
            <p>Want to help? <a href="#donate">Donate</a>, <a href="#volunteer">volunteer</a>, or <a href="#adopt">adopt</a> today!</p>
        </div>
    );
};
