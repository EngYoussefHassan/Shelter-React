...
const HowToUpload = () => {
  return (
    <div className="container mx-auto my-5 mt-10 px-4">
      ...
      <ol className="list-decimal ml-8 md:ml-12">
        <li className="mb-6">
          <h3 className="font-semibold text-blue-700 text-xl">1. Create an Account:</h3>
          <img src="/path/to/image1.jpg" alt="Create Account" className="mb-2 rounded shadow-lg w-full md:w-2/3 mx-auto" />
        ...
        <li className="mb-6">
          ...
          <img src="/path/to/image2.jpg" alt="Log In" className="mb-2 rounded shadow-lg w-full md:w-2/3 mx-auto" />
          <p className="text-gray-600">
        ...
        <li className="mb-6">
          ...
          <img src="/path/to/image3.jpg" alt="Upload Form" className="mb-2 rounded shadow-lg w-full md:w-2/3 mx-auto" />
          <p className="text-gray-600">
        ...
        <li className="mb-6">
          ...
          <img src="/path/to/image4.jpg" alt="Fill Pet Details" className="mb-2 rounded shadow-lg w-full md:w-2/3 mx-auto" />
          <p className="text-gray-600">
        ...
        <li className="mb-6">
          ...
          <img src="/path/to/image5.jpg" alt="Submit Upload" className="mb-2 rounded shadow-lg w-full md:w-2/3 mx-auto" />
          <p className="text-gray-600">
        ...
        <li className="mb-6">
          ...
          <img src="/path/to/image6.jpg" alt="Confirmation" className="mb-2 rounded shadow-lg w-full md:w-2/3 mx-auto" />
          <p className="text-gray-600">
